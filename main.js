...
(function () {
  ...
  document.getElementById('fonte-aumentar').addEventListener('click', () => {
    if (estado.tamanho < TAMANHO_MAX) { estado.tamanho += TAMANHO_PASSO; salvar(); aplicarTudo(); }
  });
  document.getElementById('fonte-diminuir').addEventListener('click', () => {
    if (estado.tamanho > TAMANHO_MIN) { estado.tamanho -= TAMANHO_PASSO; salvar(); aplicarTudo(); }
  });
  document.getElementById('fonte-resetar').addEventListener('click', () => {
    estado.tamanho = TAMANHO_PADRAO; salvar(); aplicarTudo();
  });
